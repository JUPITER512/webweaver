	...
	return (
		<>
			<section className=" h-full w-full relative flex items-center justify-center flex-col">
				...
				<div className="bg-gradient-to-r from-primary to-secondary-foreground text-transparent bg-clip-text relative">
					<h1 className="text-[420%] font-bold text-center md:text-[180px]">
						WebWeaver
					</h1>
					</div>
				<div className=" flex justify-center items-center relative md:mt-[-50px]"> 
				<Image src={'/assets/preview.png'} alt="Banner Image " height={1200} width={1200} className=" rounded-tl-2xl rounded-tr-2xl border-muted"/>
		...
		<section className="flex justify-center items-center flex-col gap-4 md:!mt-20 mt-[-60px]">
			...
			<p className=" text-muted-foreground text-center">
				Our StraightForward Pricing Plans are tailored to meet your needs. If {"you're"} not read to commit you can get started for free
			</p>
